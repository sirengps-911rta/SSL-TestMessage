...
object SBJ {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val envProps = props.getConfig("batch")
    ...
    val lines = spark.
      ...
      .option("endingOffsets", "latest").option("subscribe", "RTA-INCIDENT-MESSAGE")
    ...
    // The write the program to sink

    payloadFlattenedDf.coalesce(1).write.format("json").save("/home/sushil/Desktop/BatchExtractionSpark442")
